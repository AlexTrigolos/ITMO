Сущность User представляет из себя пользователя. Ключом является самоинкрементирующийся id, так же user имеет уникальный E-mail, имеет имя и массив запесей (Post)
